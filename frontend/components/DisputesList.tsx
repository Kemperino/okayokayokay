...
function getStatusIcon(status: RequestStatus) {
  if (status === RequestStatus.DisputeOpened || status === RequestStatus.DisputeRejected || status === RequestStatus.DisputeEscalated) {
    return (
            ...
            <div className="mt-4 pt-4 border-t border-contrast">
              <div className="flex items-center justify-between">
                <div className="text-sm text-primary/60">
                  ...
                  {dispute.contractStatus.status === RequestStatus.DisputeRejected && (
                    <span>Dispute rejected by seller - can be escalated</span>
                  )}
